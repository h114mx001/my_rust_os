...
pub fn copy_files(verbose: bool) {
    ...
    copy_file(
        "/ini/palettes/catpucchin-mocha.csv",
        include_bytes!("../../dsk/ini/palettes/catpucchin-mocha.csv"),
        verbose,
    );
    ...
    copy_file(
        "/ini/fonts/JetBrainsMono-Medium.psf",
        include_bytes!("../../dsk/ini/fonts/JetBrainsMono-Medium.psf"),
        verbose,
    );

    copy_file(
        "/ini/fonts/font.psf",
        include_bytes!("../../dsk/ini/fonts/font.psf"),
        verbose,
    );
...
pub fn main(args: &[&str]) -> Result<(), ExitCode> {
    ...
    println!(
        "{}Welcome to RUST_OS v{} installation program!{}",
        csi_color,
